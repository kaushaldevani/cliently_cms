		 ...
		 <div class="main_area col-sm-4">
                 ...
                 <!-- final Submit data Area -->
                    <div class="submit_area">
                       <button id="add_page" type="button" class="btn btn-primary btn-lg" style="width: 50%;">Add</button>
                    </div>
						...
						data-step="work-pane-email-video">
							<form class="form work-form form-horizontal">
								...
								<div class="tab-content" style="margin-top: 3%;">
									...
									<div
									id="work-creation-wizard-step-work-pane-emailVideo-tab-pane-Message"
									class="tab-pane fade">
	
										<div class="form-group"><label
											class="control-label col-md-2 text-right">Subject: </label>
											<div class="col-md-10"><span class="form-control"
												id="email-sub-spn" style="padding: 0px;"> <input
													type="text"
													class="form-control email-title email-sub can-have-token"
													title="Subject" name="title">
											</span></div></div>
										<div class="form-group">
											<div class="col-md-12">
												<div class="btn-toolbar" id="editor-toolbar-2"
												data-target="#editor-for-video-Email">
													<div class="btn-group"><a class="btn btn-xs"
														data-wysihtml5-command="bold" title="Bold (Ctrl/Cmd+B)"><i
															class="fa fa-bold"></i></a> <a class="btn btn-xs"
